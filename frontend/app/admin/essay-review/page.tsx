...
export default function AdminEssayReviewPage() {
 ...
 target="_blank"
 rel="noreferrer"
 className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-white border border-slate-200 text-slate-700 text-xs font-semibold hover:bg-slate-50 transition"
 >
 ...
 className="w-full bg-slate-50/70 border border-slate-200/90 rounded-xl px-3.5 py-2.5 text-[15px] font-normal text-slate-900 focus:bg-white focus:outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-100 transition shadow-2xs placeholder-slate-400"
 />
 </div>
 </div>
 ...
 <div className="flex items-center bg-white border border-slate-200 rounded-xl px-2.5 py-1 shadow-2xs">
 <input
 type="number"
 min={1}
 max={240}
