        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            ...
            <input
              ...
              className="h-10 w-full rounded-xl border border-slate-200/60 dark:border-slate-800 bg-white dark:bg-slate-900 px-3.5 text-type-body font-semibold text-slate-800 dark:text-slate-100  focus:border-blue-500 focus:outline-none"
            />
          </div>
