          ...
          {[
            {
              ...
              progressPercent: selectedScheduleId ? 100 : 0,
              icon: Zap,
            },
            {
              ...
              progressPercent: rooms.length > 0 ? Math.round((availableCount / rooms.length) * 100) : 100,
              icon: DoorOpen,
            },
            {
              ...
              progressPercent: selectedCapacity > 0 ? 100 : 0,
              icon: Users,
            },
            {
