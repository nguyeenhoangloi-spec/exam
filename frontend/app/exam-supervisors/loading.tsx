    ...
    <main className="w-full px-6 py-6 space-y-5 bg-slate-50/50 min-h-screen">
      ...
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between pb-1">
        <div className="space-y-2">
          ...
          <div className="h-4 w-96 rounded-lg bg-slate-100 dark:bg-slate-800/60 animate-pulse" />
        </div>
      ...
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 py-0.5">
        <div className="flex items-center gap-3.5">
          ...
          <div className="space-y-1.5">
            <div className="h-5 w-72 rounded-lg bg-slate-200 dark:bg-slate-800 animate-pulse" />
            <div className="h-3.5 w-52 rounded-lg bg-slate-100 dark:bg-slate-800/60 animate-pulse" />
          </div>
        </div>
