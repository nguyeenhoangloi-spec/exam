        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-5">
          ...
          <div className="rounded-2xl border border-slate-200/90 bg-white p-5 shadow-2xs space-y-4">
                            ...
                            <div>
                              <div className="sticky top-0 bg-slate-50 px-4 py-2 border-b border-slate-100 z-10 flex items-center justify-between">
                                ...
                                {expiredUnassigned.length > 0 && (
                                  <span className="text-[9.5px] font-semibold text-slate-400 bg-slate-200/70 px-1.5 py-0.5 rounded">
                                ...
                                <>
                                  ...
                                  {expiredUnassigned.length > 0 && (
                                    <div className="bg-slate-50/80 border-t-2 border-slate-200/80 mt-1">
                                      <div className="px-4 py-1.5 text-[9.5px] font-semibold text-slate-400 uppercase tracking-wider bg-slate-100 flex items-center gap-1">
                                        ...
                                        return (
                                          ...
                                          >
                                            <div className="flex items-center justify-between gap-1">
                                              ...
                                              <span className="text-[9px] font-semibold text-slate-400 bg-slate-200 px-1.5 py-0.5 rounded shrink-0">Đã kết thúc</span>
                                            </div>
                                    ...
                                    <div className="bg-slate-50/80 border-t-2 border-slate-200/80 mt-1">
                                      ...
                                      {expiredAssigned.map((s: any) => {
                                        ...
                                        return (
                                          ...
                                          >
                                            <div className="flex items-center justify-between gap-1">
                                              <p className="text-[11px] font-semibold text-slate-600 truncate flex-1">
                                                {s.subject?.subjectName || s.subjectName}
                                              </p>
                                              <span className="text-[9px] font-semibold text-slate-400 bg-slate-200 px-1.5 py-0.5 rounded shrink-0">
                                                {count} GT · Đã xong
                                              </span>
                                            </div>
                                            <p className="text-[10px] text-slate-400 font-medium mt-0.5">
            ...
            {selectedSchedule && (
              <div className={`rounded-xl border p-3.5 text-xs space-y-1.5 ${
                ...
                {selectedSchedule.mode === 'MOCK' && (
                  <span className="inline-block mb-1 font-semibold text-[11px] bg-blue-100 border border-blue-300 text-blue-900 px-2.5 py-0.5 rounded-full">
                ...
                <p className="font-medium text-slate-600">
                  Mã môn: <span className="font-mono tabular-nums font-medium text-slate-900">{selectedSchedule.subject?.subjectCode}</span>
                </p>
                <p className="font-medium text-slate-600">
          ...
          <div className="lg:col-span-2 space-y-5">
            ...
            <div className="rounded-2xl border border-slate-200/90 bg-white shadow-2xs overflow-hidden">
              <div className="p-4 bg-slate-50/80 border-b border-slate-200 font-semibold text-xs uppercase tracking-wider text-slate-700 flex justify-between items-center">
                <span>
                  {statusFilter === 'ALL'
