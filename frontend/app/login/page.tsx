        ...
        <div className="relative z-10 flex flex-col h-full p-8 xl:p-12 justify-between">
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-3.5">
              ...
              <div>
                <p className="text-[12px] font-semibold tracking-[0.2em] text-blue-200 ">Exam System</p>
            ...
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/10 border border-white/20 text-white text-[12px] font-semibold tracking-wider backdrop-blur-md">
        ...
        <div className="relative z-10 flex justify-between items-center p-6 shrink-0">
          <div className="flex lg:hidden items-center gap-2.5">
            ...
            <div>
              ...
              <p className="text-[12px] font-semibold text-blue-600 tracking-wider">Hệ thống khảo thí</p>
            </div>
          </div>
