...
export default function LoginPage() {
  ...
  return (
    <div
      className={`min-h-screen w-full relative overflow-x-hidden font-sans antialiased flex flex-col justify-between transition-colors duration-300 ${
    ...
    >
        ...
        <section className="lg:col-span-5 flex justify-center w-full">
          ...
          >
            ...
            <div className="text-center mb-5">
              ...
              <h2 className="text-2xl sm:text-[25px] font-bold text-slate-900 dark:text-white tracking-tight">
                Đăng nhập hệ thống
              </h2>
      ...
      {/* ── Page Bottom Footer ── */}
      <footer className="relative z-10 w-full py-4 text-center text-xs text-slate-500 dark:text-slate-400 space-y-1">
