...
export default function StudentExamLobbyPage() {
 ...
 <span className="inline-flex items-center gap-[6px] text-[13px] font-semibold tracking-wide text-blue-100">
 ...
 <div>
 <span className="text-[13px] font-semibold text-blue-200 tracking-wider block">Thời gian làm bài</span>
 ...
 <span className=" tabular-nums font-medium text-[#0F172A] text-[15px] block">
 {studentCode}
 </span>
 </div>
