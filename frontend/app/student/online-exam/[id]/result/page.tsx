  ...
  if (loading) {
    return (
      <div className="min-h-screen bg-slate-950 text-white flex items-center justify-center">
        ...
        <span className="ml-3 text-slate-300">Đang tải thông tin kết quả...</span>
      </div>
    );
  }
      ...
      <div className="max-w-3xl mx-auto bg-slate-900 border border-slate-800 rounded-2xl p-8 shadow-2xl">
        ...
        {isUnderReview && (
          <div className="bg-amber-500/10 border border-amber-500/20 p-6 rounded-xl mb-8">
            <h3 className="text-sm font-bold text-amber-300 uppercase tracking-wider mb-2 flex items-center">
        ...
        <div className="flex justify-center">
          <button
            onClick={() => router.push('/student/exam-schedule')}
            className="px-6 py-3 bg-slate-800 hover:bg-slate-700 text-slate-200 text-sm font-semibold rounded-xl flex items-center transition"
          >
