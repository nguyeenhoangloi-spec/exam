        ...
        <main className="flex-1 p-6 md:p-8 overflow-y-auto max-w-4xl mx-auto w-full">
          {currentQ && (
            <div className="bg-white border border-slate-200 rounded-2xl p-6 shadow-sm">
              ...
              <div className="text-slate-800 text-base md:text-lg leading-relaxed font-medium mb-6">
                {currentQ.content}
              </div>
                    ...
                    >
                      <div
                        className={`w-6 h-6 rounded-${
                          ...
                          isSelected ? 'bg-indigo-600 border-indigo-500 text-white' : 'border-slate-200 bg-white text-slate-700'
                        }`}
                      >
