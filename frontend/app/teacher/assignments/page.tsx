        ...
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between pb-1">
          <div className="space-y-1">
            ...
            <p className="text-xs font-semibold text-slate-500">
              Giảng viên: <strong className="text-slate-800 font-extrabold">{currentUser?.fullName || currentUser?.username || '---'}</strong> ({currentUser?.code || currentUser?.username || '---'}) &nbsp;•&nbsp; Danh sách ca coi thi được phân công trong học kỳ
            </p>
          </div>
