      ...
      <div className="flex min-h-screen flex-col min-w-0 bg-slate-50/50">
        <main className="p-8 max-w-7xl w-full mx-auto space-y-6">
          ...
          <div className="flex flex-wrap items-center justify-between gap-4">
            <div>
              <h1 className="text-xl font-bold text-slate-900">Quản lý Hồ sơ Giảng viên</h1>
              <p className="text-xs text-slate-500 mt-0.5">Quản lý danh mục cán bộ giảng dạy, học vị, khoa và lịch coi thi</p>
            </div>
