                ...
                >
                  <div className="space-y-3">
                    <div className="flex items-start justify-between gap-3">
                      ...
                      <span className={`inline-flex items-center gap-1 px-2 py-0.5 rounded-lg text-[10.5px] font-extrabold ${
                        remainingDays <= 5 ? 'text-rose-700' : 'text-amber-700'
                      }`}>
                      ...
                      >
                        ...
                        {visibleColumns.expiresIn && (
                          <td className={`px-5 whitespace-nowrap ${viewMode === 'compact' ? 'py-2.5' : 'py-4'}`}>
                            <span className={`inline-flex items-center gap-1.5 px-2 py-0.5 rounded-lg text-[10.5px] font-extrabold ${
                              remainingDays <= 5
                                ? 'text-rose-700'
                                : 'text-amber-700'
                            }`}>
