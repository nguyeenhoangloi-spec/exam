    ...
    <main className="w-full px-6 py-6 space-y-5 bg-slate-50/50 min-h-screen">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <button
          ...
          className={`p-5 rounded-2xl border text-left transition cursor-pointer flex items-center justify-between shadow-2xs ${
        ...
        >
          ...
          <div className={`w-10 h-10 rounded-xl flex items-center justify-center shrink-0 ${
            activeCategory === 'schedules' ? 'bg-blue-600 text-white' : 'bg-blue-50 text-blue-600 border border-blue-100'
          }`}>
        ...
        >
          ...
          <div className={`w-10 h-10 rounded-xl flex items-center justify-center shrink-0 ${
            activeCategory === 'papers' ? 'bg-blue-600 text-white' : 'bg-blue-50 text-blue-600 border border-blue-100'
          }`}>
        ...
        >
          ...
          <div className={`w-10 h-10 rounded-xl flex items-center justify-center shrink-0 ${
            activeCategory === 'questions' ? 'bg-blue-600 text-white' : 'bg-blue-50 text-blue-600 border border-blue-100'
          }`}>
        ...
        >
          ...
          <div className={`w-10 h-10 rounded-xl flex items-center justify-center shrink-0 ${
            ['users', 'subjects', 'classes'].includes(activeCategory) ? 'bg-blue-600 text-white' : 'bg-blue-50 text-blue-600 border border-blue-100'
          }`}>
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="flex items-center rounded-xl border border-slate-200/80 bg-white p-1 shadow-2xs">
              ...
              <button
                ...
                className={`p-1.5 rounded-lg transition cursor-pointer ${
                  viewMode === 'grid' ? 'bg-blue-50 text-blue-600 font-bold' : 'text-slate-400 hover:text-slate-700'
                }`}
                title="Xem dạng lưới"
              >
              ...
              <button
                ...
                className={`p-1.5 rounded-lg transition cursor-pointer ${
                  viewMode === 'compact' ? 'bg-blue-50 text-blue-600 font-bold' : 'text-slate-400 hover:text-slate-700'
                }`}
                ...
                >
                  <div className="space-y-3">
                    <div className="flex items-start justify-between gap-3">
                      ...
                      <span className={`inline-flex items-center gap-1 px-2.5 py-1 rounded-lg text-[10.5px] font-extrabold ${
                        remainingDays <= 5 ? 'bg-rose-50 text-rose-700' : 'bg-amber-50 text-amber-900'
                      }`}>
                  ...
                  <div className="pt-3 border-t border-slate-100 flex items-center justify-end gap-2">
                    <button
                      ...
                      className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-slate-200/80 bg-white hover:bg-emerald-50 hover:border-emerald-200 text-slate-700 hover:text-emerald-700 text-xs font-bold transition shadow-2xs cursor-pointer active:scale-95"
                    >
                    ...
                    <button
                      ...
                      className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-slate-200/80 bg-white hover:bg-rose-50 hover:border-rose-200 text-slate-700 hover:text-rose-700 text-xs font-bold transition cursor-pointer shadow-2xs active:scale-95"
                    >
          ...
          <div className="bg-white border border-slate-200/80 rounded-2xl shadow-2xs overflow-hidden">
            <div className="overflow-x-auto">
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="border-b border-slate-100 bg-slate-50/70 text-[10.5px] font-black uppercase text-slate-400 tracking-wider">
                      ...
                      >
                        ...
                        {visibleColumns.expiresIn && (
                          <td className={`px-5 whitespace-nowrap ${viewMode === 'compact' ? 'py-2.5' : 'py-4'}`}>
                            <span className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg text-[10.5px] font-extrabold ${
                              remainingDays <= 5
                        ...
                        {visibleColumns.actions && (
                          <td className={`px-5 text-right whitespace-nowrap ${viewMode === 'compact' ? 'py-2.5' : 'py-4'}`}>
                            <div className="inline-flex items-center gap-2">
                              ...
                              <button
                                onClick={() => handleHardDelete(item)}
                                className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-slate-200/80 bg-white hover:bg-rose-50 hover:border-rose-200 text-slate-700 hover:text-rose-700 text-xs font-bold transition shadow-2xs cursor-pointer active:scale-95"
                              >
                                <Trash2 className="w-3.5 h-3.5 text-rose-600" />
                                Xóa vĩnh viễn
                              </button>
