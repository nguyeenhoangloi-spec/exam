                ...
                >
                  <div className="space-y-3">
                    <div className="flex items-start justify-between gap-3">
                      ...
                      <span className={`inline-flex items-center gap-1 px-2.5 py-1 rounded-lg text-[10.5px] font-extrabold ${
                        remainingDays <= 5 ? 'bg-rose-50 text-rose-700 border border-rose-200' : 'bg-amber-50 text-amber-800 border border-amber-200/80'
                      }`}>
                  ...
                  <div className="pt-3 border-t border-slate-100 flex items-center justify-end gap-2">
                    <button
                      ...
                      className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-emerald-200 bg-emerald-50 hover:bg-emerald-100 text-emerald-700 text-xs font-extrabold transition cursor-pointer shadow-2xs active:scale-95"
                    >
                    ...
                    <button
                      ...
                      className="inline-flex items-center gap-1.5 px-3 py-1.5 rounded-lg border border-rose-200 bg-rose-50 hover:bg-rose-100 text-rose-700 text-xs font-extrabold transition cursor-pointer shadow-2xs active:scale-95"
                    >
                      ...
                      >
                        ...
                        {visibleColumns.expiresIn && (
                          <td className={`px-5 whitespace-nowrap ${viewMode === 'compact' ? 'py-2.5' : 'py-4'}`}>
                            <span className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-xl text-[10.5px] font-extrabold ${
                              remainingDays <= 5
                        ...
                        {visibleColumns.deletedBy && (
                          <td className={`px-5 font-bold text-slate-700 whitespace-nowrap ${viewMode === 'compact' ? 'py-2.5' : 'py-4'}`}>
                            <span className="inline-flex items-center px-2.5 py-1 rounded-xl bg-slate-100/80 border border-slate-200/60 text-slate-700 text-[11px] font-bold">
                              {item.deletedBy}
                            </span>
                          </td>
                        )}
