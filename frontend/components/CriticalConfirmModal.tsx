...
export const CriticalConfirmModal: React.FC<CriticalConfirmModalProps> = ({
  ...
  return createPortal(
    ...
    >
      <div className="w-full max-w-lg overflow-hidden rounded-2xl bg-white dark:bg-slate-900 shadow-apple-modal border border-slate-200/90 dark:border-slate-800 flex flex-col max-h-[calc(100dvh-1.5rem)] animate-modal-dialog will-change-transform sm:max-h-[calc(100dvh-2rem)]">
