...
export const Header: React.FC<HeaderProps> = ({
  ...
  return (
    <>
      ...
      <header className="sticky top-0 z-30 flex h-14 w-full bg-white/95 dark:bg-slate-900/95 backdrop-blur-md transition-all border-b border-slate-200/70 dark:border-slate-700/70 shadow-2xs">
                    ...
                    {notifications.map((item) => {
                      ...
                      return (
                        <div
                          ...
                          className={`rounded-xl p-3 transition border cursor-pointer space-y-1.5 group ${
                            isUnread
