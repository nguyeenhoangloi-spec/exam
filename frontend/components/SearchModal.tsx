...
const ALL_SEARCH_ITEMS: SearchItem[] = [
  ...
  {
    id: 'admin-settings',
    title: 'Cấu hình sao lưu & lưu trữ hệ thống',
    desc: 'Cấu hình tự động sao lưu, lưu trữ đám mây và thông số máy chủ',
    href: '/admin/settings',
    icon: Settings,
    roles: ['ADMIN'],
    category: 'Quản trị & Bảo mật',
  ...
  {
    id: 'settings',
    title: 'Tùy chọn giao diện & tài khoản',
    desc: 'Tùy chỉnh giao diện, chế độ sáng/tối và thông báo cá nhân',
    href: '/settings',
    icon: Settings,
    roles: ['ADMIN', 'TEACHER', 'STUDENT'],
    category: 'Tài khoản',
