                  ...
                  <div className="space-y-1.5">
                    ...
                    >
                      <div className="min-w-0 pr-2">
                        <div className={`text-xs font-bold ${selectedSizeRange === 'over40' ? 'text-blue-700 dark:text-blue-300' : 'text-slate-800 dark:text-slate-200'}`}>
                          Lớp đông sinh viên (&gt; 40 SV)
                        </div>
                        <div className={`text-[11px] truncate ${selectedSizeRange === 'over40' ? 'text-blue-600/80 dark:text-blue-300/80' : 'text-slate-500 dark:text-slate-400'}`}>
                    ...
                    >
                      <div className="min-w-0 pr-2">
                        <div className={`text-xs font-bold ${selectedSizeRange === '20to40' ? 'text-blue-700 dark:text-blue-300' : 'text-slate-800 dark:text-slate-200'}`}>
                          Quy mô vừa (20 - 40 SV)
                        </div>
                        <div className={`text-[11px] truncate ${selectedSizeRange === '20to40' ? 'text-blue-600/80 dark:text-blue-300/80' : 'text-slate-500 dark:text-slate-400'}`}>
