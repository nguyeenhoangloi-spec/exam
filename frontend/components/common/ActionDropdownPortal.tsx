      ...
      {isOpen &&
        createPortal(
          <div
            ...
            className="z-[99999] min-w-[210px] w-max max-w-xs rounded-2xl border border-slate-200/60 dark:border-slate-700 bg-white dark:bg-slate-900 p-1.5 shadow-2xl text-type-body-sm font-medium text-slate-700 dark:text-slate-200 space-y-0.5 text-left animate-popover-in will-change-transform"
          >
