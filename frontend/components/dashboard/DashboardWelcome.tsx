...
export function DashboardWelcome({
  ...
  return (
    <div className="relative overflow-hidden rounded-2xl bg-blue-600 p-6 text-white shadow-md min-h-[120px] flex flex-col sm:flex-row sm:items-center justify-between gap-4">
      ...
      <div className="pointer-events-none absolute right-4 top-1/2 -translate-y-1/2 hidden md:block w-72 h-32 opacity-30">
        <svg viewBox="0 0 320 160" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
          ...
          <path d="M160 30L300 90L160 150L20 90L160 30Z" fill="#1D4ED8" fillOpacity="0.6" />
          ...
          {/* Floating 3D Calculator Icon */}
          <rect x="250" y="80" width="22" height="26" rx="4" fill="#3B82F6" />
