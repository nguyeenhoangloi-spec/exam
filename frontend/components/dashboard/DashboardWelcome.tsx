  ...
  return (
    <div className="rounded-2xl bg-primary-800 border border-white/10 px-6 py-5 text-white shadow-xl flex flex-col sm:flex-row sm:items-center justify-between gap-4">
      ...
      <div className="space-y-1">
        <h2 className="text-type-section font-semibold text-white tracking-tight leading-tight">
          Xin chào, <span className="text-blue-200">{username}</span>! 👋
        </h2>
        <p className="text-type-helper font-medium text-blue-100/80 leading-relaxed">
          Hôm nay có{' '}
      ...
      <div className="flex items-center gap-2 shrink-0">
        <button
          ...
          className="flex items-center gap-1.5 rounded-xl bg-white/15 hover:bg-white/25 border border-white/20 text-white px-4 py-2 text-type-helper font-medium transition active:scale-95 cursor-pointer"
        >
