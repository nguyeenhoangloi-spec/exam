...
export function ArrangementSchedulePickerModal({
  ...
  return createPortal(
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4">
      {/* Overlay */}
      <div className="fixed inset-0 bg-slate-950/55 backdrop-blur-xs transition-opacity" onClick={onClose} />

      {/* Modal Box */}
      <div className="relative z-10 w-full max-w-2xl rounded-2xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-900 shadow-2xl overflow-hidden flex flex-col max-h-[85vh]">
                ...
                >
                  ...
                  <div className="space-y-1 min-w-0 flex-1">
                    <div className="flex items-center gap-2 flex-wrap">
                      ...
                      {isMock && (
                        <span className="px-1.5 py-0.2 rounded text-type-helper font-semibold bg-blue-50 dark:bg-blue-950 text-blue-700 dark:text-blue-300">
                          Thi thử
                        </span>
                      )}
                      {isSelected && (
