                  ...
                  <div className="space-y-1.5">
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2 shrink-0">
                        <span className={`rounded-md px-1.5 py-0.5 text-type-helper font-semibold ${statusFilter === 'PUBLISHED'
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2 shrink-0">
                        <span className={`rounded-md px-1.5 py-0.5 text-type-helper font-semibold ${statusFilter === 'DRAFT'
                            ? 'bg-blue-600 text-white'
                            : 'bg-slate-100 text-slate-600 dark:bg-slate-800 dark:text-slate-300'
                          }`}>
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2 shrink-0">
                        <span className={`rounded-md px-1.5 py-0.5 text-type-helper font-semibold ${selectedExamType === 'TRAC_NGHIEM'
                            ? 'bg-blue-600 text-white'
                            : 'bg-slate-100 text-slate-600 dark:bg-slate-800 dark:text-slate-300'
                          }`}>
                ...
                {activeCategory === 'schedule' && (
                  <div className="space-y-1.5">
                    ...
                    >
                      ...
                      <div className="flex items-center gap-2 shrink-0">
                        <span className={`rounded-md px-1.5 py-0.5 text-type-helper font-semibold ${selectedScheduleId === ''
                            ? 'bg-blue-600 text-white'
