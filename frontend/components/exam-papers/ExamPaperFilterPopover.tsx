                  ...
                  <div className="space-y-1.5">
                    ...
                    >
                      <div className="min-w-0 pr-2">
                        ...
                        <div className={`text-[11px] truncate ${statusFilter === 'PUBLISHED' ? 'text-blue-600/80 dark:text-blue-300/80' : 'text-slate-500 dark:text-slate-400'}`}>
                    ...
                    >
                      <div className="min-w-0 pr-2">
                        ...
                        <div className={`text-[11px] truncate ${statusFilter === 'DRAFT' ? 'text-blue-600/80 dark:text-blue-300/80' : 'text-slate-500 dark:text-slate-400'}`}>
                    ...
                    >
                      <div className="min-w-0 pr-2">
                        ...
                        <div className={`text-[11px] truncate ${selectedExamType === 'TRAC_NGHIEM' ? 'text-blue-600/80 dark:text-blue-300/80' : 'text-slate-500 dark:text-slate-400'}`}>
                  ...
                  <div className="space-y-1.5">
                    ...
                    >
                      <div className="min-w-0 pr-2">
                        ...
                        <div className={`text-[10.5px] truncate ${selectedScheduleId === '' ? 'text-blue-600/80 dark:text-blue-400/80' : 'text-slate-400 dark:text-slate-500'}`}>
