              ...
              <div className="col-span-8 p-3 overflow-y-auto custom-scrollbar">
                  ...
                  <div className="space-y-1.5">
                    ...
                    >
                      <div className="min-w-0 pr-2">
                        <div className={`text-type-helper font-semibold ${selectedStatus === 'ONGOING' ? 'text-blue-700 dark:text-blue-300' : 'text-slate-800 dark:text-slate-200'}`}>
                          Kỳ thi đang diễn ra
                        </div>
                        <div className={`text-type-helper truncate ${selectedStatus === 'ONGOING' ? 'text-blue-600/80 dark:text-blue-300/80' : 'text-slate-500 dark:text-slate-400'}`}>
                    ...
                    >
                      <div className="min-w-0 pr-2">
                        <div className={`text-type-helper font-semibold ${selectedStatus === 'UPCOMING' ? 'text-blue-700 dark:text-blue-300' : 'text-slate-800 dark:text-slate-200'}`}>
                          Kỳ thi sắp tới
                        </div>
                        <div className={`text-type-helper truncate ${selectedStatus === 'UPCOMING' ? 'text-blue-600/80 dark:text-blue-300/80' : 'text-slate-500 dark:text-slate-400'}`}>
                    ...
                    >
                      <div className="min-w-0 pr-2">
                        <div className={`text-type-helper font-semibold ${selectedSchoolYear === (schoolYearsList[0] || '2025-2026') ? 'text-blue-700 dark:text-blue-300' : 'text-slate-800 dark:text-slate-200'}`}>
                          Năm học mới nhất ({schoolYearsList[0] || '2025-2026'})
                        </div>
                        <div className={`text-type-helper truncate ${selectedSchoolYear === (schoolYearsList[0] || '2025-2026') ? 'text-blue-600/80 dark:text-blue-300/80' : 'text-slate-500 dark:text-slate-400'}`}>
                          Niên khóa hiện hành
                        </div>
                      </div>
                ...
                {activeCategory === 'schoolYear' && (
                  <div className="space-y-1.5">
                    ...
                    >
                      <div className="min-w-0 pr-2">
                        <div className={`text-type-helper font-semibold ${selectedSchoolYear === '' ? 'text-blue-700 dark:text-blue-300 font-semibold' : 'text-slate-800 dark:text-slate-200'}`}>
                          Tất cả các năm học
                        </div>
                        <div className={`text-type-helper truncate ${selectedSchoolYear === '' ? 'text-blue-600/80 dark:text-blue-400/80' : 'text-slate-400 dark:text-slate-500'}`}>
