                ...
                {activeCategory === 'presets' && (
                  <div className="space-y-1.5">
                    ...
                    {summaryOptions?.periods && summaryOptions.periods[0] && (
                      ...
                      >
                        <div className="min-w-0 pr-2">
                          <div className={`text-xs font-semibold ${summaryFilters.examPeriodId === String(summaryOptions.periods[0].id) ? 'text-blue-700 dark:text-blue-300 font-bold' : 'text-slate-800 dark:text-slate-200'}`}>
                            Kỳ thi {summaryOptions.periods[0].name}
                          </div>
                          <div className={`text-[10.5px] truncate ${summaryFilters.examPeriodId === String(summaryOptions.periods[0].id) ? 'text-blue-600/80 dark:text-blue-400/80' : 'text-slate-400 dark:text-slate-500'}`}>
                    ...
                    {summaryOptions?.departments && summaryOptions.departments[0] && (
                      ...
                      >
                        <div className="min-w-0 pr-2">
                          <div className={`text-xs font-semibold ${summaryFilters.departmentId === String(summaryOptions.departments[0].id) ? 'text-blue-700 dark:text-blue-300 font-bold' : 'text-slate-800 dark:text-slate-200'}`}>
                            Khoa {summaryOptions.departments[0].name}
                          </div>
                          <div className={`text-[10.5px] truncate ${summaryFilters.departmentId === String(summaryOptions.departments[0].id) ? 'text-blue-600/80 dark:text-blue-400/80' : 'text-slate-400 dark:text-slate-500'}`}>
                  ...
                  <div className="space-y-1.5">
                    ...
                    >
                      <div className="min-w-0 pr-2">
                        ...
                        <div className={`text-[10.5px] truncate ${summaryFilters.examPeriodId === 'ALL' ? 'text-blue-600/80 dark:text-blue-400/80' : 'text-slate-400 dark:text-slate-500'}`}>
                    ...
                    {summaryOptions?.periods?.map((item) => (
                      ...
                      >
                        <div className="min-w-0 pr-2">
                          ...
                          <div className={`text-[10.5px] truncate ${summaryFilters.examPeriodId === String(item.id) ? 'text-blue-600/80 dark:text-blue-400/80' : 'text-slate-400 dark:text-slate-500'}`}>
                            Đợt thi #{item.id}
                          </div>
                        </div>
                  ...
                  <div className="space-y-1.5">
                    ...
                    >
                      <div className="min-w-0 pr-2">
                        ...
                        <div className={`text-[10.5px] truncate ${summaryFilters.subjectId === 'ALL' ? 'text-blue-600/80 dark:text-blue-400/80' : 'text-slate-400 dark:text-slate-500'}`}>
                    ...
                    {summaryOptions?.subjects?.map((item) => (
                      ...
                      >
                        <div className="min-w-0 pr-2">
                          ...
                          <div className={`text-[10.5px] truncate ${summaryFilters.subjectId === String(item.id) ? 'text-blue-600/80 dark:text-blue-400/80' : 'text-slate-400 dark:text-slate-500'}`}>
                            Mã môn: {item.code}
                          </div>
                        </div>
                  ...
                  <div className="space-y-1.5">
                    ...
                    >
                      <div className="min-w-0 pr-2">
                        ...
                        <div className={`text-[10.5px] truncate ${summaryFilters.departmentId === 'ALL' ? 'text-blue-600/80 dark:text-blue-400/80' : 'text-slate-400 dark:text-slate-500'}`}>
                    ...
                    {summaryOptions?.departments?.map((item) => (
                      ...
                      >
                        <div className="min-w-0 pr-2">
                          ...
                          <div className={`text-[10.5px] truncate ${summaryFilters.departmentId === String(item.id) ? 'text-blue-600/80 dark:text-blue-400/80' : 'text-slate-400 dark:text-slate-500'}`}>
                  ...
                  <div className="space-y-1.5">
                    ...
                    >
                      <div className="min-w-0 pr-2">
                        ...
                        <div className={`text-[10.5px] truncate ${summaryFilters.classId === 'ALL' ? 'text-blue-600/80 dark:text-blue-400/80' : 'text-slate-400 dark:text-slate-500'}`}>
                    ...
                    {summaryOptions?.classes?.map((item) => (
                      ...
                      >
                        <div className="min-w-0 pr-2">
                          ...
                          <div className={`text-[10.5px] truncate ${summaryFilters.classId === String(item.id) ? 'text-blue-600/80 dark:text-blue-400/80' : 'text-slate-400 dark:text-slate-500'}`}>
