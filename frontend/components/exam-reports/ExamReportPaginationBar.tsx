...
export function ExamReportPaginationBar({
  page,
  totalPages,
  limit,
  totalItems,
  ...
  return (
    <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between pt-3">
      <p className="text-[14px] font-normal text-[#64748B]">
        ...
        <span className="font-semibold text-[#0F172A]">{totalItems.toLocaleString('vi-VN')}</span> Thí sinh
      </p>
