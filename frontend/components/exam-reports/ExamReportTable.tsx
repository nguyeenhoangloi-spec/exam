              ...
              <div className="space-y-2.5">
                ...
                <div className="flex items-center justify-between pt-1">
                  <div className="flex flex-col">
                    ...
                    <span className={`text-lg font-black ${c.status === 'ABSENT' ? 'text-rose-600' : isPassed ? 'text-emerald-600' : 'text-amber-600'}`}>
        ...
        <table className="w-full text-left text-xs text-slate-700 border-collapse">
          ...
          <tbody className="divide-y divide-slate-100 font-medium">
            {candidates.map((c) => {
              ...
              return (
                <tr key={c.studentId} className={`transition hover:bg-blue-50/40 ${isChecked ? 'bg-blue-50/60' : ''}`}>
                  ...
                  <td className={`p-2 whitespace-nowrap text-center font-black ${c.status === 'ABSENT' ? 'text-rose-600' : c.totalScore >= 5 ? 'text-emerald-600' : 'text-amber-600'}`}>
                ...
                {visibleColumns.totalScore !== false && (
                  <td className="p-3.5 whitespace-nowrap text-center font-black">
                    {c.status === 'ABSENT' ? (
                      ...
                      <span
                        className={`text-sm ${
                          c.totalScore >= 5 ? 'text-emerald-600 font-extrabold' : 'text-amber-600 font-extrabold'
                        }`}
                      >
                        {c.totalScore}
                      </span>
