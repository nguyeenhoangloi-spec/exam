...
export function ExamRoomPaginationBar({
  page,
  totalPages,
  limit,
  totalItems,
  ...
  return (
    <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between pt-3">
      <p className="text-xs font-semibold text-slate-500">
        ...
        <span className="font-extrabold text-slate-900">{totalItems.toLocaleString('vi-VN')}</span> phòng thi
      </p>
