...
export function ExamScheduleBulkAction({
  ...
  return (
    <div className="fixed bottom-6 left-0 right-0 md:left-[252px] [html.sidebar-collapsed_&]:md:left-[72px] flex justify-center z-40 pointer-events-none px-4 transition-[left] duration-300">
      <div className="pointer-events-auto max-w-full flex items-center gap-3 rounded-2xl border border-slate-800 bg-slate-900 p-2.5 px-4 text-white shadow-2xl animate-in fade-in slide-in-from-bottom-5 duration-200">
