...
import { Eye, Trash2, ShieldCheck, DoorOpen, GraduationCap, User } from 'lucide-react';
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
        {supervisors.map((s) => {
          ...
          return (
            <div
              key={s.id}
              className={`rounded-2xl border bg-white dark:bg-slate-900 p-5 shadow-2xs transition-all hover:shadow-md ${
                isChecked
            ...
            >
              <div className="flex items-start justify-between gap-3">
                <div className="flex items-center gap-3">
                  ...
                  <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-blue-50 dark:bg-blue-950/60 text-blue-600 dark:text-blue-400 font-bold">
              ...
              <div className="mt-4 flex items-center justify-end gap-2 pt-2 border-t border-slate-100 dark:border-slate-800">
                <button
                  type="button"
                  onClick={() => onView(s)}
                  className="flex h-8 w-8 items-center justify-center rounded-lg text-slate-400 hover:text-blue-600 hover:bg-blue-50 dark:hover:bg-slate-800 transition cursor-pointer"
                  title="Xem chi tiết"
                >
                ...
                {isAdmin && (
                  <button
                    ...
                    className="flex h-8 w-8 items-center justify-center rounded-lg text-slate-400 hover:text-rose-600 hover:bg-rose-50 dark:hover:bg-slate-800 transition cursor-pointer"
                    title="Hủy phân công"
                  >
          ...
          return (
            ...
            >
              <div className="flex items-center gap-3 min-w-0">
                ...
                <span className="text-[11px] text-slate-400 truncate">({s.teacher?.degree || 'TS'})</span>
              ...
              <div className="flex items-center gap-3 shrink-0">
                ...
                <div className="flex items-center gap-1">
                  <button
                    type="button"
                    onClick={() => onView(s)}
                    className="p-1 rounded text-slate-400 hover:text-blue-600 hover:bg-slate-100 dark:hover:bg-slate-800 transition cursor-pointer"
                    title="Xem chi tiết"
                  >
    ...
    <div className="overflow-hidden rounded-2xl border border-slate-200/90 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-2xs">
      <div className="overflow-x-auto">
        <table className="w-full text-left text-xs text-slate-600 dark:text-slate-300">
          <thead className="border-b border-slate-200/90 dark:border-slate-800 bg-slate-50/75 dark:bg-slate-800/75 font-semibold text-slate-700 dark:text-slate-200">
            <tr>
              {isAdmin && (
