                  ...
                  <div className="space-y-1.5">
                    ...
                    >
                      <div className="min-w-0 pr-2">
                        <div className={`text-xs font-semibold ${statusFilter === 'ALL' && riskFilter === 'ALL' ? 'text-blue-700 dark:text-blue-300' : 'text-slate-800 dark:text-slate-200'}`}>
                          Tất cả thí sinh
                        </div>
                        <div className={`text-[12px] truncate ${statusFilter === 'ALL' && riskFilter === 'ALL' ? 'text-blue-600/80 dark:text-blue-300/80' : 'text-slate-500 dark:text-slate-400'}`}>
                          Toàn bộ danh sách phòng thi
                        </div>
                      </div>

                      <div className="flex items-center gap-2 shrink-0">
                        <span className={`rounded-md px-1.5 py-0.5 text-[12px] font-semibold ${statusFilter === 'ALL' && riskFilter === 'ALL'
                    ...
                    >
                      <div className="min-w-0 pr-2">
                        <div className={`text-xs font-semibold ${statusFilter === 'FLAGGED' ? 'text-rose-700 dark:text-rose-300' : 'text-slate-800 dark:text-slate-200'}`}>
                          Có cảnh báo vi phạm
                        </div>
                        <div className={`text-[12px] truncate ${statusFilter === 'FLAGGED' ? 'text-rose-600/80 dark:text-rose-300/80' : 'text-slate-500 dark:text-slate-400'}`}>
                          Gian lận / Đổi tab / Thoát toàn màn hình
                        </div>
                      </div>

                      <div className="flex items-center gap-2 shrink-0">
                        <span className={`rounded-md px-1.5 py-0.5 text-[12px] font-semibold ${statusFilter === 'FLAGGED'
                    ...
                    >
                      <div className="min-w-0 pr-2">
                        <div className={`text-xs font-semibold ${statusFilter === 'DISCONNECTED' ? 'text-amber-700 dark:text-amber-300' : 'text-slate-800 dark:text-slate-200'}`}>
                          Mất kết nối mạng
                        </div>
                        <div className={`text-[12px] truncate ${statusFilter === 'DISCONNECTED' ? 'text-amber-600/80 dark:text-amber-300/80' : 'text-slate-500 dark:text-slate-400'}`}>
                          Mất tín hiệu heartbeat quá 30s
                        </div>
                      </div>

                      <div className="flex items-center gap-2 shrink-0">
                        <span className={`rounded-md px-1.5 py-0.5 text-[12px] font-semibold ${statusFilter === 'DISCONNECTED'
                    ...
                    >
                      <div className="min-w-0 pr-2">
                        <div className={`text-xs font-semibold ${riskFilter === 'HIGH' ? 'text-rose-700 dark:text-rose-300' : 'text-slate-800 dark:text-slate-200'}`}>
                          Rủi ro cao (≥ 40đ)
                        </div>
                        <div className={`text-[12px] truncate ${riskFilter === 'HIGH' ? 'text-rose-600/80 dark:text-rose-300/80' : 'text-slate-500 dark:text-slate-400'}`}>
                          Cần giám thị theo dõi trực tiếp
                        </div>
                      </div>

                      <div className="flex items-center gap-2 shrink-0">
                        <span className={`rounded-md px-1.5 py-0.5 text-[12px] font-semibold ${riskFilter === 'HIGH'
                            ? 'bg-rose-600 text-white'
                            : 'bg-rose-100 text-rose-600 dark:bg-rose-950 dark:text-rose-300'
                          }`}>
                          {counts.highRisk}
                  ...
                  <div className="space-y-1.5">
                    ...
                    {[
                      ...
                      return (
                        ...
                        >
                          <div className="min-w-0 pr-2">
                            <div className={`text-xs font-semibold ${isSel ? 'text-blue-700 dark:text-blue-300' : 'text-slate-800 dark:text-slate-200'}`}>
                              {st.label}
                            </div>
                            <div className={`text-[12px] truncate ${isSel ? 'text-blue-600/80 dark:text-blue-300/80' : 'text-slate-500 dark:text-slate-400'}`}>
                              {st.desc}
                            </div>
                          </div>

                          <div className="flex items-center gap-2 shrink-0">
                            <span className={`rounded-md px-1.5 py-0.5 text-[12px] font-semibold ${isSel
                                ? 'bg-blue-600 text-white'
                                : 'bg-slate-100 text-slate-600 dark:bg-slate-800 dark:text-slate-300'
                              }`}>
                              {st.count}
