                  ...
                  <div className="space-y-1.5">
                    ...
                    >
                      <div className="min-w-0 pr-2">
                        ...
                        <div className={`text-[11px] truncate ${statusFilter === 'ALL' && riskFilter === 'ALL' ? 'text-blue-600/80 dark:text-blue-300/80' : 'text-slate-500 dark:text-slate-400'}`}>
                    ...
                    >
                      <div className="min-w-0 pr-2">
                        ...
                        <div className={`text-[11px] truncate ${statusFilter === 'FLAGGED' ? 'text-rose-600/80 dark:text-rose-300/80' : 'text-slate-500 dark:text-slate-400'}`}>
                    ...
                    >
                      <div className="min-w-0 pr-2">
                        ...
                        <div className={`text-[11px] truncate ${statusFilter === 'DISCONNECTED' ? 'text-amber-600/80 dark:text-amber-300/80' : 'text-slate-500 dark:text-slate-400'}`}>
                    ...
                    >
                      <div className="min-w-0 pr-2">
                        ...
                        <div className={`text-[11px] truncate ${riskFilter === 'HIGH' ? 'text-rose-600/80 dark:text-rose-300/80' : 'text-slate-500 dark:text-slate-400'}`}>
                      ...
                      return (
                        ...
                        >
                          <div className="min-w-0 pr-2">
                            ...
                            <div className={`text-[11px] truncate ${isSel ? 'text-blue-600/80 dark:text-blue-300/80' : 'text-slate-500 dark:text-slate-400'}`}>
                              {st.desc}
                            </div>
                          </div>
