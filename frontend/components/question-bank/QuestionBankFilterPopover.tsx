                  ...
                  <div className="space-y-1.5">
                    ...
                    >
                      <div className="min-w-0 pr-2">
                        ...
                        <div className={`text-[11px] truncate ${filters.type === 'SINGLE_CHOICE' ? 'text-blue-600/80 dark:text-blue-300/80' : 'text-slate-500 dark:text-slate-400'}`}>
                    ...
                    >
                      <div className="min-w-0 pr-2">
                        ...
                        <div className={`text-[11px] truncate ${filters.difficulty === 'EASY' ? 'text-blue-600/80 dark:text-blue-300/80' : 'text-slate-500 dark:text-slate-400'}`}>
                    ...
                    {subjects.length > 0 && (
                      ...
                      >
                        <div className="min-w-0 pr-2">
                          ...
                          <div className={`text-[11px] truncate ${filters.subjectId === String(subjects[0].id) ? 'text-blue-600/80 dark:text-blue-300/80' : 'text-slate-500 dark:text-slate-400'}`}>
                  ...
                  <div className="space-y-1.5">
                    ...
                    >
                      <div className="min-w-0 pr-2">
                        ...
                        <div className={`text-[10.5px] truncate ${filters.subjectId === '' ? 'text-blue-600/80 dark:text-blue-400/80' : 'text-slate-400 dark:text-slate-500'}`}>
