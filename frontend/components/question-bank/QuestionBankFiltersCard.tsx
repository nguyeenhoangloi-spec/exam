...
const selectCls =
  'h-9 w-full appearance-none rounded-xl border border-slate-200 bg-white pl-3 pr-8 text-xs font-semibold text-slate-700 outline-none hover:border-slate-300 focus:border-blue-600 focus:ring-2 focus:ring-blue-500/15 transition cursor-pointer shadow-2xs';
