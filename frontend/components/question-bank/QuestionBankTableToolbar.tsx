  ...
  return (
    <div className="flex flex-wrap items-center justify-between gap-3 py-1">
      ...
      <span className="text-xs font-bold text-slate-700">
        Tổng số <span className="font-black text-slate-900">{totalCount.toLocaleString('vi-VN')}</span> câu hỏi
      </span>
          ...
          {openColumnMenu && (
            ...
            >
              <div className="flex items-center justify-between border-b border-slate-100 pb-1.5">
                <span className="font-extrabold text-slate-900 text-xs">Tùy chỉnh hiển thị cột</span>
