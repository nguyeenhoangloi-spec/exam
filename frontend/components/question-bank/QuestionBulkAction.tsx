        ...
        <div className="flex flex-wrap items-center justify-center gap-1.5 sm:gap-2">
          ...
          {canSubmit && (
            <button
              ...
              className={
                isSubmitPrimary
                  ? 'group relative overflow-hidden h-9 flex items-center gap-2 rounded-xl bg-blue-600 hover:bg-blue-700 text-white px-4 text-type-helper font-semibold shadow-xs shadow-blue-500/25 transition-all cursor-pointer hover:-translate-y-0.5 active:translate-y-0 active:scale-95'
                  : 'h-9 flex items-center gap-2 rounded-xl text-slate-700 dark:text-slate-200 hover:text-blue-600 dark:hover:text-blue-400 hover:bg-slate-100 dark:hover:bg-slate-800 px-3.5 text-type-helper font-medium transition-all cursor-pointer hover:-translate-y-0.5 active:translate-y-0 active:scale-95'
              }
            >
              {isSubmitPrimary && (
                <span className="absolute inset-0 w-1/2 h-full bg-white/20 transform -skew-x-12 -translate-x-full group-hover:translate-x-[300%] transition-transform duration-700 ease-out pointer-events-none" />
          ...
          {canRestore && (
            <button
              ...
              className={
                isRestorePrimary
                  ? 'h-9 flex items-center gap-2 rounded-xl bg-blue-600 hover:bg-blue-700 text-white px-4 text-type-helper font-semibold shadow-xs shadow-blue-500/25 transition-all cursor-pointer hover:-translate-y-0.5 active:translate-y-0 active:scale-95'
                  : 'h-9 flex items-center gap-2 rounded-xl text-slate-700 dark:text-slate-200 hover:text-blue-600 dark:hover:text-blue-400 hover:bg-slate-100 dark:hover:bg-slate-800 px-3.5 text-type-helper font-medium transition-all cursor-pointer hover:-translate-y-0.5 active:translate-y-0 active:scale-95'
              }
            >
          ...
          {canArchive && (
            <button
              ...
              className="h-9 flex items-center gap-2 rounded-xl text-slate-700 dark:text-slate-200 hover:text-slate-900 dark:hover:text-white hover:bg-slate-100 dark:hover:bg-slate-800 px-3.5 text-type-helper font-medium transition-all cursor-pointer hover:-translate-y-0.5 active:translate-y-0 active:scale-95"
            >
