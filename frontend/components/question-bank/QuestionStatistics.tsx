      ...
      {items.map((item) => {
        ...
        return (
          <div
            ...
            className={`group flex flex-col justify-between rounded-2xl border p-4 shadow-apple-card cursor-pointer transition-all duration-200 hover:-translate-y-0.5 hover:border-slate-300/90 dark:hover:border-slate-700 hover:shadow-apple-card-hover ${
              isActive
