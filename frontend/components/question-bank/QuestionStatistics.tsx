      ...
      {items.map((item) => {
        ...
        return (
          <div
            ...
            className={`group flex flex-col justify-between rounded-2xl border p-4 shadow-2xs cursor-pointer transition-all duration-200 hover:-translate-y-1 hover:border-blue-400 hover:shadow-md ${
              isActive
          ...
          >
            <div className="flex items-start justify-between gap-3 w-full">
              <div className="space-y-1 min-w-0">
                ...
                <div className="text-[32px] font-bold text-slate-900 leading-[38px] tracking-tight tabular-nums">{item.count}</div>
              </div>
