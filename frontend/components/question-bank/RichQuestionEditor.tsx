...
export function RichQuestionEditor({
 ...
 return (
 <div className="overflow-hidden rounded-xl border border-slate-200/60 bg-white shadow-2xs">
 ...
 <span className="text-type-helper font-normal text-slate-500">
 Công thức: nhập giữa <code className="bg-slate-200/60 px-1 py-0.5 rounded text-slate-700 tabular-nums text-type-helper">\(...\)</code> hoặc <code className="bg-slate-200/60 px-1 py-0.5 rounded text-slate-700 tabular-nums text-type-helper">$$...$$</code>
 </span>
 </div>
 ...
 className="min-h-[120px] p-3.5 text-type-body font-medium text-slate-900 leading-6 outline-none empty:before:text-slate-400 empty:before:content-[attr(data-placeholder)]"
 />
 </div>
 );
}
