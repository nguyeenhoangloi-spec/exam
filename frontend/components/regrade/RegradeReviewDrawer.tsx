...
export function RegradeReviewDrawer({
 ...
 <span className=" tabular-nums font-medium text-blue-600 text-xs">
 ...
 <div className="rounded-xl bg-white p-3 border border-slate-200 text-slate-900 tabular-nums text-[12px] leading-relaxed">
 {ans.studentAnswer}
 </div>
 </div>
 ))}
