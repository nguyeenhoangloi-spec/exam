            ...
            >
              <div className="space-y-2.5">
                <div className="flex items-center justify-between gap-2 border-b border-slate-100 pb-2.5">
                  <div className="flex items-center gap-2.5">
                    ...
                    <div>
                      ...
                      <p className="text-xs font-mono tabular-nums font-medium text-slate-400">{item.student.studentCode}</p>
                    </div>
                  </div>
                ...
                <div className="bg-slate-50/80 p-3 rounded-xl border border-slate-100 space-y-0.5">
                  <p className="font-semibold text-[#0F172A] text-xs">{subjectName}</p>
                  {subjectCode && <p className="text-xs font-mono tabular-nums font-medium text-blue-600">{subjectCode}</p>}
                </div>
              ...
              return (
                <tr key={item.id} className="transition hover:bg-blue-50/40">
                  <td className="p-2.5 pl-3.5 whitespace-nowrap">
                    ...
                    <span className="text-xs font-mono tabular-nums font-medium text-slate-400 ml-1.5">({item.student.studentCode})</span>
                  </td>
              ...
              <tr key={item.id} className="transition hover:bg-blue-50/40">
                ...
                {visibleColumns.student !== false && (
                  <td className="p-3.5 pl-4 whitespace-nowrap">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="font-semibold text-[#0F172A] text-sm leading-snug">{item.student.fullName}</p>
                        <p className="text-xs font-mono tabular-nums font-medium text-slate-400 mt-0.5">
                ...
                {visibleColumns.subject !== false && (
                  <td className="p-3.5 min-w-[200px]">
                    ...
                    {subjectCode && (
                      <span className="inline-block font-mono tabular-nums text-xs font-medium text-slate-500 bg-slate-50 px-2 py-0.5 rounded border border-slate-200/80 mt-1">
                        {subjectCode}
                      </span>
                    )}
                  </td>
