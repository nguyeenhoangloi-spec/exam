                  ...
                  <div className="space-y-1.5">
                    ...
                    >
                      <div className="min-w-0 pr-2">
                        <div className={`text-xs font-semibold ${filterCredits === '3' ? 'text-blue-700 dark:text-blue-300' : 'text-slate-800 dark:text-slate-200'}`}>
                          Môn học 3 Tín chỉ
                        </div>
                        <div className={`text-[12px] truncate ${filterCredits === '3' ? 'text-blue-600/80 dark:text-blue-300/80' : 'text-slate-500 dark:text-slate-400'}`}>
                          Học phần lý thuyết tiêu chuẩn của trường
                        </div>
                      </div>

                      <div className="flex items-center gap-2 shrink-0">
                        <span className={`rounded-md px-1.5 py-0.5 text-[12px] font-semibold ${filterCredits === '3'
                    ...
                    >
                      <div className="min-w-0 pr-2">
                        <div className={`text-xs font-semibold ${filterHasStudents === 'yes' ? 'text-blue-700 dark:text-blue-300' : 'text-slate-800 dark:text-slate-200'}`}>
                          Đã có sinh viên đăng ký
                        </div>
                        <div className={`text-[12px] truncate ${filterHasStudents === 'yes' ? 'text-blue-600/80 dark:text-blue-300/80' : 'text-slate-500 dark:text-slate-400'}`}>
                          Các môn đã có danh sách lớp học phần
                        </div>
                      </div>

                      <div className="flex items-center gap-2 shrink-0">
                        <span className={`rounded-md px-1.5 py-0.5 text-[12px] font-semibold ${filterHasStudents === 'yes'
                            ? 'bg-blue-600 text-white'
                            : 'bg-slate-100 text-slate-600 dark:bg-slate-800 dark:text-slate-300'
                          }`}>
