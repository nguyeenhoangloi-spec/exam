                  ...
                  <div className="space-y-1.5">
                    ...
                    >
                      <div className="min-w-0 pr-2">
                        <div className={`text-xs font-bold ${selectedDegree === 'TS' ? 'text-blue-700 dark:text-blue-300' : 'text-slate-800 dark:text-slate-200'}`}>
                          Học vị Tiến sĩ (TS)
                        </div>
                        <div className={`text-[11px] truncate ${selectedDegree === 'TS' ? 'text-blue-600/80 dark:text-blue-300/80' : 'text-slate-500 dark:text-slate-400'}`}>
                          Danh sách giảng viên có trình độ Tiến sĩ
                        </div>
                      </div>

                      <div className="flex items-center gap-2 shrink-0">
                        <span className={`rounded-md px-1.5 py-0.5 text-[11px] font-bold ${selectedDegree === 'TS'
                    ...
                    >
                      <div className="min-w-0 pr-2">
                        <div className={`text-xs font-bold ${selectedStatus === 'has_dept' ? 'text-blue-700 dark:text-blue-300' : 'text-slate-800 dark:text-slate-200'}`}>
                          Đã thuộc Khoa
                        </div>
                        <div className={`text-[11px] truncate ${selectedStatus === 'has_dept' ? 'text-blue-600/80 dark:text-blue-300/80' : 'text-slate-500 dark:text-slate-400'}`}>
                          Giảng viên đã phân công vào Khoa
                        </div>
                      </div>

                      <div className="flex items-center gap-2 shrink-0">
                        <span className={`rounded-md px-1.5 py-0.5 text-[11px] font-bold ${selectedStatus === 'has_dept'
                            ? 'bg-blue-600 text-white'
                            : 'bg-slate-100 text-slate-600 dark:bg-slate-800 dark:text-slate-300'
                          }`}>
