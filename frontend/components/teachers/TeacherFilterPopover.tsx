                  ...
                  <div className="space-y-1.5">
                    ...
                    >
                      <div className="min-w-0 pr-2">
                        <div className={`text-type-helper font-semibold ${selectedDegree === 'TS' ? 'text-blue-700 dark:text-blue-300' : 'text-slate-800 dark:text-slate-200'}`}>
                          Học vị Tiến sĩ (TS)
                        </div>
                        <div className={`text-type-helper truncate ${selectedDegree === 'TS' ? 'text-blue-600/80 dark:text-blue-300/80' : 'text-slate-500 dark:text-slate-400'}`}>
                    ...
                    >
                      <div className="min-w-0 pr-2">
                        <div className={`text-type-helper font-semibold ${selectedStatus === 'has_dept' ? 'text-blue-700 dark:text-blue-300' : 'text-slate-800 dark:text-slate-200'}`}>
                          Đã thuộc Khoa
                        </div>
                        <div className={`text-type-helper truncate ${selectedStatus === 'has_dept' ? 'text-blue-600/80 dark:text-blue-300/80' : 'text-slate-500 dark:text-slate-400'}`}>
