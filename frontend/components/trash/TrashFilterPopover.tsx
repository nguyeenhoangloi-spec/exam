                  ...
                  <div className="space-y-1.5">
                    ...
                    >
                      <div className="min-w-0 pr-2">
                        <div className={`text-type-helper font-semibold ${activeCategory === 'schedules' && !expiryFilter ? 'text-blue-700 dark:text-blue-300' : 'text-slate-800 dark:text-slate-200'}`}>
                          Lịch thi đã xóa
                        </div>
                    ...
                    >
                      <div className="min-w-0 pr-2">
                        <div className={`text-type-helper font-semibold ${activeCategory === 'questions' && !expiryFilter ? 'text-blue-700 dark:text-blue-300' : 'text-slate-800 dark:text-slate-200'}`}>
                          Câu hỏi đã xóa
                        </div>
                        <div className="text-type-helper text-slate-500 dark:text-slate-400 truncate">
                    ...
                    >
                      <div className="min-w-0 pr-2">
                        <div className={`text-type-helper font-semibold ${expiryFilter === 'expiring_soon' ? 'text-rose-700 dark:text-rose-300' : 'text-slate-800 dark:text-slate-200'}`}>
                ...
                {currCategoryTab === 'categories' && (
                  <div className="space-y-1.5">
                    {[
                      ...
                      >
                        <div className="min-w-0 pr-2">
                          <div className={`text-type-helper font-semibold ${activeCategory === item.key ? 'text-blue-700 dark:text-blue-300' : 'text-slate-800 dark:text-slate-200'}`}>
                            {item.label}
                          </div>
                          <div className="text-type-helper text-slate-500 dark:text-slate-400 truncate">
                            {item.desc}
                ...
                {currCategoryTab === 'expiry' && (
                  <div className="space-y-1.5">
                    {[
                      ...
                      >
                        <div className="min-w-0 pr-2">
                          <div className={`text-type-helper font-semibold ${expiryFilter === item.key ? 'text-blue-700 dark:text-blue-300' : 'text-slate-800 dark:text-slate-200'}`}>
                            {item.label}
                          </div>
                          <div className="text-type-helper text-slate-500 dark:text-slate-400 truncate">
                            {item.desc}
