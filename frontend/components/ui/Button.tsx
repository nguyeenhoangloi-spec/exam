...
const variantStyles: Record<ButtonVariant, string> = {
  ...
  secondary:
    'bg-white text-[#334155] hover:bg-[#F8FAFC] active:bg-slate-100 border border-[#E2E8F0] hover:border-[#CBD5E1] focus:ring-2 focus:ring-slate-400/20 focus:outline-none font-semibold cursor-pointer transition-all duration-150',
  outline:
    'bg-white text-[#334155] hover:bg-[#F8FAFC] active:bg-slate-100 border border-[#E2E8F0] hover:border-[#CBD5E1] focus:ring-2 focus:ring-slate-400/20 focus:outline-none font-semibold cursor-pointer transition-all duration-150',
  ghost:
  ...
  'danger-outline':
    'bg-white text-[#DC2626] hover:bg-rose-50 active:bg-rose-100 border border-rose-200 hover:border-rose-300 focus:ring-2 focus:ring-rose-400/20 focus:outline-none font-semibold cursor-pointer transition-all duration-150',
  success:
...
const sizeStyles: Record<ButtonSize, string> = {
  ...
  sm: 'h-8 px-3 text-[14px] font-semibold rounded-xl gap-1.5',
  md: 'h-[38px] px-3.5 text-[15px] font-semibold rounded-xl gap-2',
  lg: 'h-[42px] px-4.5 text-[15px] font-bold rounded-xl gap-2',
