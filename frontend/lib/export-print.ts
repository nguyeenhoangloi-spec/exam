...
export function printReport(options: PrintReportOptions): boolean {
  ...
  const headerTableHtml = motto?.trim()
    ? `<table class="header-table"><tr><td class="inst-box"><table style="border-collapse:collapse;margin:0 auto;border:none;width:auto;"><tr>${logoHtml ? `<td style="vertical-align:middle;padding-right:8px;border:none;width:52px;text-align:center;">${logoHtml}</td>` : ''}<td style="vertical-align:middle;text-align:center;border:none;"><div>${escapeHtml(institutionName)}</div>${facultyName ? `<span>${escapeHtml(facultyName)}</span>` : ''}<div style="border-top:1px solid #000;display:inline-block;padding-top:2px;width:110px;margin-top:2px"></div></td></tr></table></td><td class="motto-box"><div>${escapeHtml(motto.split('\n')[0] || 'CỘNG HÒA XÃ HỘI CHỦ NGHĨA VIỆT NAM')}</div><em>${escapeHtml(motto.split('\n')[1] || 'Độc lập - Tự do - Hạnh phúc')}</em><div style="border-top:1px solid #000;display:inline-block;padding-top:2px;width:110px;margin-top:2px"></div></td></tr></table>`
    : `<table class="header-table"><tr><td class="inst-box" style="width:100%"><table style="border-collapse:collapse;margin:0 auto;border:none;width:auto;"><tr>${logoHtml ? `<td style="vertical-align:middle;padding-right:8px;border:none;width:52px;text-align:center;">${logoHtml}</td>` : ''}<td style="vertical-align:middle;text-align:center;border:none;"><div>${escapeHtml(institutionName)}</div>${facultyName ? `<span>${escapeHtml(facultyName)}</span>` : ''}<div style="border-top:1px solid #000;display:inline-block;padding-top:2px;width:110px;margin-top:2px"></div></td></tr></table></td></tr></table>`;
        ...
        <tr>
          <td style="width: 50%; text-align: center;">
            <table style="border-collapse:collapse;margin:0 auto;border:none;width:auto;">
              <tr>
                ${logoHtml ? `<td style="vertical-align:middle;padding-right:8px;border:none;width:52px;text-align:center;">${logoHtml}</td>` : ''}
