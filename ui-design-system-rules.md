...
- `soft`: nền xanh siêu nhạt (`bg-blue-50`), chữ xanh đậm (`text-blue-700`), **không viền**, **không icon**, dùng cho tính năng tự động / hỗ trợ đặc biệt.
